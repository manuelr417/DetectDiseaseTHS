...
def main():
    ...
    P = ProcessTweetsWord2VecTwoPassLSTMv2_1("data/cleantextlabels4.csv", "data/glove.6B.50d.txt")
    ...
    # el 4 con dropout
    P.process("trained/modellstmatt7.json", "trained/modellstmatt7.h5", plot=False, epochs=30)
#joderme
