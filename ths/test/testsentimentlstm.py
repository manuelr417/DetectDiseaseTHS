...
def main():
    ...
    P = ProcessTweetsWord2VecOnePassLSTMv2_1("data/cleantextlabels4.csv", "data/glove.6B.50d.txt")

    #Bueno el model12cnnv2
    P.process("trained/modellstm6.json", "trained/modellstm6.h5", plot=True, epochs=10)
#joderme
