...
from ths.nn.sequences.cnn1d import TweetSentiment1D
...
class ProcessTweetsCNN1D:
    ...
    def process(self, json_filename, h5_filename, plot=False, epochs = 100, vect_dimensions = 50):
        ...
        history = NN.fit(X_train, Y_train, epochs=epochs, batch_size=64, class_weight=class_weight_dictionary, validation_split=0.10)
