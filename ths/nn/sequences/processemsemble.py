...
from ths.nn.sequences.ensemble import TweetEnsemble1_2Layers, TweetEnsemble1_3Layers
...
class ProcessTweetsWord2VecOnePassEnsemble:
    ...
    def process(self, json_filename, h5_filename, plot=False, epochs = 100, vect_dimensions = 100):
        ...
        NN =TweetEnsemble1_3Layers(trim_size, G)
        #print("Build GRU")
        ...
        NN.build(first_layer_units = max_len, second_layer_units = max_len, relu_dense_layer=64, dense_layer_units = 1,
